                                ...
                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                    ...
                                    <tbody>
                                        <tr v-for="item in items" :key="item.id">
                                            ...
                                            <td class="border-b-2 border-gray-200px-4 py-3">{{  item.name }}</td>
                                            <td class="border-b-2 border-gray-200px-4 py-3">{{  item.price }}</td>
                                            <!-- <td class="border-b-2 border-gray-200px-4 py-3">{{ item.is_selling ? '販売中' : '販売停止中' }}</td> -->
                                             <td class="border-b-2 border-gray-200px-4 py-3">
